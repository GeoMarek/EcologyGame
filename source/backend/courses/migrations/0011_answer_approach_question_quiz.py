    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('selecting_result', models.CharField(choices=[('b', 'Best'), ('l', 'Last')], default='b', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quiz', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='courses.quiz')),
            ],
        ),
        migrations.CreateModel(
            name='Approach',
            fields=[
                ...
                ('result_in_percent', models.DecimalField(decimal_places=2, max_digits=4)),
                ('quiz', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='courses.quiz')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('approach', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='courses.approach')),
                ('question', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='courses.question')),
            ],
        ),
    ]
